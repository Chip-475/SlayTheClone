...
public class MapGenerator : MonoBehaviour
{
    ...
    //            {
    //                current.forwardConnections.Add(entryNode.nodeId);
    //                continue;
    //            }
    ...
    //                        {
    //                            current.forwardConnections.Add(prev.nodeId);
    //                        }
    //                    }
    //                }
    //            }
    ...
    //                if (Random.Range(0, 4) == 0)
    //                {
    //                    current.forwardConnections.Add(possible.nodeId);
    //                }
    //            }
    //            if (current.forwardConnections.Count == 0 && possibleConnection.Count > 0)
    //            {
    //                current.forwardConnections.Add(possibleConnection[Random.Range(0, possibleConnection.Count)].nodeId);
    //            }
    //        }
    ...
    //            foreach (Node current in nodes)
    //            {
    //                if (current.layerId == i && current.forwardConnections.Contains(prev.nodeId))
    //                {
    //                    hasExit = true;
    //                    break;
    //                }
    ...
    //                    target.forwardConnections.Add(prev.nodeId);
    //                }
    //            }
    //        }
    //        foreach (Node current in nodes) 
    ...
    //            foreach (Node prev in nodes) 
    //            { 
    //                if (current.forwardConnections.Contains(prev.nodeId)) 
    //                { 
    //                    hasEntry = true; 
    //                    break;
    //                } 
    ...
    //                    current.forwardConnections.Add(source.nodeId);
    //                }
    //            }
    //        }
    //    }
    ...
    //    {
    //        foreach (int id in node.forwardConnections)
    //        {
