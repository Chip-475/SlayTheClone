...
public class Lich : Enemy
{
    ...
    IEnumerator BasicAttack()
    {
        ...
        var effectPosition = new Vector2(CombatManager.instance.player.transform.position.x + 0.5f, CombatManager.instance.player.transform.position.y + 2);
        var effect = Instantiate(attackEffect, effectPosition, Quaternion.identity);
        effect.GetComponent<LichAttackEffect>().destroyTime = animLength;
